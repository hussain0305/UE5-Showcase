...
#define DRAW_SPHERE_RADIUS(Location, Radius) DrawDebugSphere(GetWorld(), Location, Radius, 12, FColor::Green, false, 5.f);
...
#define PRINT_DEBUG_MESSAGE(Duration, Color, Message) if (GEngine) \
	{ \
